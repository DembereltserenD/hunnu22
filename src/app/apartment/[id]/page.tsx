...
import { ArrowLeft, Calendar, User, CheckCircle2, Plus, Eye, Clock } from "lucide-react";
...
function ApartmentDetailContent() {
  const { visits, activeSessions, workers, apartments, buildings, currentWorker, startSession, isLoading } = useRealtime();
        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600">{building.name} - Floor {apartment.floor}</p>
            </div>
            {isCurrentlyActive && (
